     ...
     return (
       <div className="w-[360px] h-[400px] flex flex-col justify-center items-center bg-tertiary sm:bg-white p-[20px] mt-[20px] md:mt-0">
         ...
         {show ? (
           <input
             type="button"
             className="w-full shadow bg-[red] hover:bg-secondary focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded cursor-pointer"
             value="Hide!"
           ...
           <input
             type="button"
             className="w-full shadow bg-[red] hover:bg-secondary focus:shadow-outline focus:outline-none text-[black] font-bold py-2 px-4 rounded cursor-pointer"
             value="Update!"
             onClick={() => setShow(!show)}
           />
         )}
