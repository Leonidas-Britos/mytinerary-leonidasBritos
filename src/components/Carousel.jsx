...
export default function Carousel({ data }) {
  ...
  return (
    <div>
      <div id="carouselComponent" className="w-[37rem] h-[38rem] pl-[3.5%] py-[3%] gap-[1.2rem] mb-[20rem] flex flex-row flex-wrap bg-[#fdfdfd] border-solid rounded-[1rem] border-[0.167rem] border-[#1c1c1c62]
      sm:w-[auto] sm:h-[auto] px-[4%] py-[5%] gap-[3rem] mb-[8rem] justify-center
      md:w-[50rem] md:h-[40rem] gap-[1rem] mb-[13%] pt-[3%] mx-auto
